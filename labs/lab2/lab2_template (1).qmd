...
ggplot() +
  geom_sf(data = county_map_data, aes(fill = pct_underserved), color = "lightgray") +
  geom_sf(data = hos, aes(color = "Hospitals"), size = 0.8, alpha = 0.9) +
  scale_color_manual(name = "", values = c("Hospitals" = "steelblue")) +
  scale_fill_gradient(name = "% Underserved Tracts among Vulnerable Tracts", low = "lightyellow", high = "darkred", na.value = "lightyellow") +
  labs(title = "Underserved Vulnerable Populations by County") +
  theme_void()
